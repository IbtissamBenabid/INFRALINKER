...
class AdminRegistrationForm(FlaskForm):
    ...
    phone = TelField('USER PHONE :', validators=[DataRequired()])
    ...
    control_platforms = BooleanField('THIS USER CAN CONTROL DEVICES')
...
class DatacenterForm(FlaskForm):
    ...
    dc_phone = StringField('DATACENTER PHONE :', validators=[DataRequired()])
    submit = SubmitField('SAVE')
